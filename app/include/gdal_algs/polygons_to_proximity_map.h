...
namespace LxGeo
{
    namespace lxProximityAlign
    {
		...
		void linestrings2proximity(IO_DATA::LineStringShapfileIO& input_shapefile, std::string& out_proximity_map_path, OGREnvelope* out_extents = NULL,
			double raster_px_size = 0.5, double raster_py_size = 0.5, ProximityMapStrategy startegy = ProximityMapStrategy::all_line);
